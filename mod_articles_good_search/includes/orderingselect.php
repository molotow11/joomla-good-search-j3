...
class JFormFieldOrderingSelect extends JFormField {	
	...
	function getInput(){
		return JFormFieldOrderingSelect::fetchElement($this->name, $this->value, $this->element, $this->options['control']);
	}
	...
	function fetchElement($name, $value, &$node, $control_name) {	
			...
			if(count($fields)) {
				...
				foreach($fields as $field) {
					// this is only default ordering options! available ordering options coded in fieldselect.php file
					if(is_object($field)) {
