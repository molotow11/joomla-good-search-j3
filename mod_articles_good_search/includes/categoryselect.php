	...
	function fetchElement($name, $value, &$node, $control_name) {
			...
			<script type='text/javascript'>
				...
				if(typeof jQuery == 'undefined') {
					...
					script.type = 'text/javascript';
					script.src = FilterPath+'js/admin/jquery-1.11.3.min.js';
				...
				function load_ui() {				
					if(typeof jQuery.ui == 'undefined') {
					   var script = document.createElement('script');
					   script.type = 'text/javascript';
					   script.src = FilterPath+'js/admin/jquery-ui.min.js';
					   document.getElementsByTagName('head')[0].appendChild(script);
										   
					   var style = document.createElement('link');
					   style.rel = 'stylesheet';
					   style.type = 'text/css';
					   style.href = FilterPath+'js/admin/jquery-ui.css';
				...
				function load_base() {			
					...
					base_script.src = FilterPath+'js/admin/filter.admin.js?v=".time()."';
