...
?>
	...
	jQuery(document).ready(function($) {
		...
		$("body").append("<div class='filter_loading<?php echo $module->id; ?>'><img src='<?php echo JURI::root(); ?>modules/mod_articles_good_search/assets/images/loading.png' /></div>");
	});
	...
	jQuery(document).ready(function($) {
		...
		<?php if($params->get("search_type") == "ajax"
				...
				&& !isset($_GET['gsearch'])
				) { //call search results on initial page loading
		?>	
		ajax_results<?php echo $module->id; ?>();
		<?php } ?>
	});
