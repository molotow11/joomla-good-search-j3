...
$categories = (array)$helper->getCategories(null, $params, 'title ASC'); // ordering [title, id, created_time, lft]
if($params->get('search_sppagebuilder')) {
	$categories = $helper->mixCategories($categories);
}				

$active = JRequest::getVar("category", array());
?>
