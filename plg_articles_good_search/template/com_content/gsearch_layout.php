...
$active = JRequest::getVar("search_layout");
...
<style>
	...
	.gsearch-layout a { display: inline-block; width: 22px; height: 22px; margin-top: 4px;
		background: url(<?php echo JURI::root(); ?>plugins/system/plg_articles_good_search/template/com_content/layout.png) no-repeat;
